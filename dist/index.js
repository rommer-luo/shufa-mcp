...
server.tool("query_calligraphy", "查询书法知识，回答书法相关问题。适用于书法学习、创作、历史、审美等各方面的知识问答。", {
...
server.tool("get_master_info", "查询历代书法名家的信息，包括生平、代表作品、风格特点等。", {
    master_name: z
        .string()
...
server.tool("get_technique_guide", "获取书法技法指导，包括执笔、运笔、笔画写法、书体特点等详细技法讲解。", {
    technique_type: z
        .enum([
        "all",
        "grip",
...
server.tool("get_aesthetic_insight", "探讨书法美学与哲学，包括审美标准、艺术鉴赏、书法文化价值等深度内容。", {
    topic: z
        .string()
        .default("书法美学概论")
...
server.tool("get_common_questions", "获取书法学习中常见问题的解答，帮助用户解决学习过程中的困惑。", {
    category: z
